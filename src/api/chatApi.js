      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "You are a professional partner who helps companies grow in domestic and international markets as an acting marketing and sales integration agent and global e-commerce operations agent and Please respond in a markdown format ",
            },
            {
                role: "user",
                content:  ` 
